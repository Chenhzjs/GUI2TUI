...
| 1.0 | Integration, Stabilization & Release Qualification | **1.0A VALIDATED; 1.0B VALIDATED; 1.0C NOT STARTED** |
...
functional / architectural feature freeze
  ...
  -> 1.0A–1.0C bounded Integration & Stabilization — 1.0A and 1.0B validated / 1.0C not started
...
release after v0.3.0 is v1.0.0. 1.0B is validated, but 1.0C execution, its
RC conclusion, and production release are not automatically authorized.
...
0.7D separately qualified Native Wayland, XWayland and one Weston 13 Headless
topology with explicit limitations. 0.7E then built exact-source GNU/Linux
x86_64 and aarch64 internal archives, qualified their ABI/layout/fresh-install
contract, and reran the approved aarch64 Managed, Docker, SSH and Wayland
...
limitations. 0.7E qualified exact-source x86_64/aarch64 internal packages,
...
The recommended next direction is **1.0C — Final Qualification & Release
Readiness**. 1.0B is validated, but 1.0C remains separately unauthorized.
This is not an RC; the v1.0.0 RC and public release remain separately
unauthorized.
